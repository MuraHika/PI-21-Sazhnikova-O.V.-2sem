...
namespace AbstractSecurityShopRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<DbContext, AbstractSecurityShopDbContext>(new HierarchicalLifetimeManager());
            container.RegisterType<ICustomerService, CustomerServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IEquipmentService, EquipmentServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<ITechnicsService, TechnicsServiceDB>(new HierarchicalLifetimeManager());
